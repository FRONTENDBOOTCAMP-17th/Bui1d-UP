...
![랜딩](./public/landingchange.png)

### 📌 회원가입 페이지 (signup)

![회원가입](./public/joinchange.png)

### 📌 로그인 페이지 (login)

![로그인](./public/loginchange.png)

### 📌 메인 페이지 (main)

![메인1](./public/mainchange1.png)

![메인2](./public/mainchange2.png)

### 📌 검색 페이지 (search)

![검색](./public/searchchange.png)

### 📌 상세 페이지 (detail)

![상세](./public/detailchange.png)
...
![마이페이지](./public/mypagechange.png)

---

## 🎬 시연 영상

[![Bui1dBox 시연 영상](https://img.youtube.com/vi/PAx8uO0EVZg/0.jpg)](https://youtu.be/PAx8uO0EVZg)
